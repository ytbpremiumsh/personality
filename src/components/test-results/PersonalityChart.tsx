...
const PersonalityChart: React.FC<PersonalityChartProps> = ({ type }) => {
  ...
  const getTraitPercentages = (mbtiType: string): TraitPair[] => {
    ...
    const defaultPairs: TraitPair[] = [
      { trait1: "Extrovert", percentage1: 25, trait2: "Introvert", percentage2: 75 },
      { trait1: "Sensing", percentage1: 65, trait2: "Intuition", percentage2: 35 },
      { trait1: "Thinking", percentage1: 35, trait2: "Feeling", percentage2: 65 },
      { trait1: "Judging", percentage1: 60, trait2: "Perceiving", percentage2: 40 },
    ];
